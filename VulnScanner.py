...
class ArmVulnScanner(VulnScanner):
    ...
    def checkVaArgs(self, current_ip, start_ea):
        local_vars = {
            "isFmt": True,
            "cntFmt": 0,
            "currentRip": current_ip,
            "cntConst": 0,
            "final_var": self.pvar[0]
        }
        firstArg = self.checkOneArg(current_ip, start_ea, 0, True)
        print(firstArg)
